...
export const experience = [
  {
    ...
    descBullets: [
      "I lead the development team and found of the company",
      "I develop and maintain web applications using JavaScript, TypeScript, HTML, CSS, Flutter, Next.js, Supabase, Postgres, Supabase Deno.",
      "I collaborate with cross-functional teams to deliver high-quality software solutions",
      "I conduct code reviews and ensure adherence to coding standards",
      "I participate in the entire software development life cycle",
      "I troubleshoot and debug applications.",
      "I implement security measures to protect applications from external threats Mentor and train junior developers",
    ],
  },
  {
    ...
    descBullets: [
      ...
      "I did clean of legacy code that are no longer in use ",
      "I destroyed areas where subscription is made without unsubscribing ",
      "I dave suggestions that speed up the development of the application",
    ],
  },
  {
    ...
    desc: "Responsibilities",
    descBullets: [
      "I develop and maintain web applications using JavaScript, TypeScript, HTML, CSS, Angular, Node.js, React, MongoDB, Postgres, MSSQL, and AWS.",
      "I collaborate with cross-functional teams to deliver high-quality software solutions",
      "I conduct code reviews and ensure adherence to coding standards",
      "I participate in the entire software development life cycle",
      "I troubleshoot and debug applications.",
...

  {
    ...
    descBullets: [
      ...
      "I increased digital sales by improving e-commerce experience on existing websites through 25+ A/B tests, resulting in 60% increase in online orders the following year, ahead of schedule by 6 months.",
    ],
  },
];
